...
ContextPadProvider.prototype.getContextPadEntries = function(element) {
  ...
  function appendAction(type, className, options, label) {
  ...
  if (is(bpmnElement, 'bpmn:FlowNode')) {
    ...
    if (!is(bpmnElement, 'bpmn:EndEvent') &&
      ...
      assign(actions, {
        'append.end-event': appendAction('bpmn:EndEvent', 'icon-red-diamond'),
        'append.gateway': appendAction('bpmn:ExclusiveGateway', 'icon-swords'),
        'append.monster': appendAction('bpmn:CallActivity', 'icon-monster', {}, 'Monster'),
        'append.riddle': appendAction('bpmn:CallActivity', 'icon-riddle', {}, 'Riddle'),
        'append.story-item': appendAction('bpmn:CallActivity', 'icon-story', {}, 'Story Item')
